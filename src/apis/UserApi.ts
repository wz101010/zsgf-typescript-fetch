...
import {
    ...
    UserFollowingResultApiResponseFromJSON,
    UserFollowingResultApiResponseToJSON,
...
export interface UserApiInterface {
     ...
     * @memberof UserApiInterface
     */
    userFollowingRaw(requestParameters: UserFollowingRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<UserFollowingResultApiResponse>>;

    /**
     * 根据条件获取我的关注列表
     * 获取我的关注列表
     */
    userFollowing(requestParameters: UserFollowingRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<UserFollowingResultApiResponse>;
     ...
     * @param {number} [ageS] 年龄段起始
     * @param {number} [ageE] 年龄段结束
     * @param {string} [tag] 兴趣标签
...
export class UserApi extends runtime.BaseAPI implements UserApiInterface {
     ...
     * 获取我的关注列表
     */
    async userFollowingRaw(requestParameters: UserFollowingRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<UserFollowingResultApiResponse>> {
        if (requestParameters['appKey'] == null) {
            throw new runtime.RequiredError(
                'appKey',
        ...
        return new runtime.JSONApiResponse(response, (jsonValue) => UserFollowingResultApiResponseFromJSON(jsonValue));
    }
     ...
     * 获取我的关注列表
     */
    async userFollowing(requestParameters: UserFollowingRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<UserFollowingResultApiResponse> {
