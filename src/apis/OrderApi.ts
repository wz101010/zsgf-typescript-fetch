...
export interface OrderApiInterface {
     ...
     */
    orderRaw(requestParameters: OrderRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<JObjectApiResult>>;

    /**
     * 订单详情
     */
    order(requestParameters: OrderRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<JObjectApiResult>;
     ...
     * @memberof OrderApiInterface
     */
    orderCreateRaw(requestParameters: OrderCreateRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<JObjectApiResult>>;

    /**
     * 创建订单
     */
    orderCreate(requestParameters: OrderCreateRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<JObjectApiResult>;
     ...
     * @param {number} [skip] 拉取的条数
     * @param {number} [take] 跳过的条数
     * @param {*} [options] Override http request option.
     * @throws {RequiredError}
     * @memberof OrderApiInterface
     */
    ordersRaw(requestParameters: OrdersRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<JObjectApiResult>>;

    /**
     * 订单列表
     */
    orders(requestParameters: OrdersRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<JObjectApiResult>;
...
export class OrderApi extends runtime.BaseAPI implements OrderApiInterface {
     ...
     * 订单详情
     */
    async orderRaw(requestParameters: OrderRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<JObjectApiResult>> {
     ...
     * 订单详情
     */
    async order(requestParameters: OrderRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<JObjectApiResult> {
     ...
     * 创建订单
     */
    async orderCreateRaw(requestParameters: OrderCreateRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<JObjectApiResult>> {
        if (requestParameters['appKey'] == null) {
            throw new runtime.RequiredError(
                'appKey',
     ...
     * 创建订单
     */
    async orderCreate(requestParameters: OrderCreateRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<JObjectApiResult> {
     ...
     * 订单列表
     */
    async ordersRaw(requestParameters: OrdersRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<JObjectApiResult>> {
        if (requestParameters['appKey'] == null) {
            throw new runtime.RequiredError(
                'appKey',
     ...
     * 订单列表
     */
    async orders(requestParameters: OrdersRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<JObjectApiResult> {
