...
import type {
  ...
  CurrencyTransactionStatsResultApiResponse,
  CurrencyTransactionTrendItemListApiResponse,
...
import {
    ...
    CurrencyTransactionStatsResultApiResponseFromJSON,
    CurrencyTransactionStatsResultApiResponseToJSON,
    CurrencyTransactionTrendItemListApiResponseFromJSON,
    CurrencyTransactionTrendItemListApiResponseToJSON,
...
export interface UserCurrencyTransactionStatsRequest {
    appKey: string;
    curCode?: string;
    startTime?: Date;
    endTime?: Date;
...
export interface UserCurrencyTransactionTrendRequest {
    appKey: string;
    curCode?: string;
    startTime?: Date;
    endTime?: Date;
...
export interface UserCurrencyApiInterface {
    ...
    /**
     * 获取用户虚拟币交易的汇总统计数据，按货币类型分组
     * @summary 虚拟币交易统计
     * @param {string} appKey 
     * @param {string} [curCode] 货币代码（可选）
     ...
     * @memberof UserCurrencyApiInterface
     */
    userCurrencyTransactionStatsRaw(requestParameters: UserCurrencyTransactionStatsRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<CurrencyTransactionStatsResultApiResponse>>;

    /**
     * 获取用户虚拟币交易的汇总统计数据，按货币类型分组
     * 虚拟币交易统计
     */
    userCurrencyTransactionStats(requestParameters: UserCurrencyTransactionStatsRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<CurrencyTransactionStatsResultApiResponse>;

    /**
     * 获取用户虚拟币交易的时间趋势数据，支持按小时/天/月聚合
     * @summary 虚拟币交易趋势
     * @param {string} appKey 
     * @param {string} [curCode] 货币代码（可选）
     * @param {Date} [startTime] 开始时间（可选）
     * @param {Date} [endTime] 结束时间（可选）
     * @param {string} [granularity] 统计粒度：hour / day / month（默认 day）
     * @param {string} [userId] 
     * @param {*} [options] Override http request option.
     * @throws {RequiredError}
     * @memberof UserCurrencyApiInterface
     */
    userCurrencyTransactionTrendRaw(requestParameters: UserCurrencyTransactionTrendRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<CurrencyTransactionTrendItemListApiResponse>>;

    /**
     * 获取用户虚拟币交易的时间趋势数据，支持按小时/天/月聚合
     * 虚拟币交易趋势
     */
    userCurrencyTransactionTrend(requestParameters: UserCurrencyTransactionTrendRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<CurrencyTransactionTrendItemListApiResponse>;
...
export class UserCurrencyApi extends runtime.BaseAPI implements UserCurrencyApiInterface {
     ...
     * 虚拟币交易统计
     */
    async userCurrencyTransactionStatsRaw(requestParameters: UserCurrencyTransactionStatsRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<CurrencyTransactionStatsResultApiResponse>> {
        if (requestParameters['appKey'] == null) {
            throw new runtime.RequiredError(
                'appKey',
                'Required parameter "appKey" was null or undefined when calling userCurrencyTransactionStats().'
            );
        }
        ...
        const response = await this.request({
            path: `/UserCurrency/{appKey}/CurrencyTransactionStats`.replace(`{${"appKey"}}`, encodeURIComponent(String(requestParameters['appKey']))),
            method: 'GET',
            headers: headerParameters,
            query: queryParameters,
        }, initOverrides);

        return new runtime.JSONApiResponse(response, (jsonValue) => CurrencyTransactionStatsResultApiResponseFromJSON(jsonValue));
    }
     ...
     * 虚拟币交易统计
     */
    async userCurrencyTransactionStats(requestParameters: UserCurrencyTransactionStatsRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<CurrencyTransactionStatsResultApiResponse> {
        const response = await this.userCurrencyTransactionStatsRaw(requestParameters, initOverrides);
        return await response.value();
    }
     ...
     * 虚拟币交易趋势
     */
    async userCurrencyTransactionTrendRaw(requestParameters: UserCurrencyTransactionTrendRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<CurrencyTransactionTrendItemListApiResponse>> {
        if (requestParameters['appKey'] == null) {
            throw new runtime.RequiredError(
                'appKey',
                'Required parameter "appKey" was null or undefined when calling userCurrencyTransactionTrend().'
            );
        }
        ...
        const response = await this.request({
            path: `/UserCurrency/{appKey}/CurrencyTransactionTrend`.replace(`{${"appKey"}}`, encodeURIComponent(String(requestParameters['appKey']))),
            method: 'GET',
            headers: headerParameters,
            query: queryParameters,
        }, initOverrides);

        return new runtime.JSONApiResponse(response, (jsonValue) => CurrencyTransactionTrendItemListApiResponseFromJSON(jsonValue));
    }
     ...
     * 虚拟币交易趋势
     */
    async userCurrencyTransactionTrend(requestParameters: UserCurrencyTransactionTrendRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<CurrencyTransactionTrendItemListApiResponse> {
        const response = await this.userCurrencyTransactionTrendRaw(requestParameters, initOverrides);
        return await response.value();
    }
